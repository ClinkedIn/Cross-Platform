...
class _MessageRequestListScreenState extends State<MessageRequestListScreen> with SingleTickerProviderStateMixin {
          ...
          return RefreshIndicator(
            ...
            child: TabBarView(
              ...
              children: [
                ...
                _buildRequestsList(viewModel.processedRequests, showActions: false),
              ],
            ),
          );
        },
  ...
  Widget _buildRequestsList(List<MessageRequest> requests, {bool showActions = true}) {
    if (requests.isEmpty) {
      return const Center(
